...
Documentation can be written as rst files in `kanban_household_supply_card_generator/docs`.
...
from inside the `kanban_household_supply_card_generator/docs` directory. 
